...
public class WednesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facultyScheduleRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_fragment_wednesday);
        ...
        String[] selectionArgs = {String.valueOf(selectedFacultyId),String.valueOf(3)};
