...
import com.example.faculty_timetable.loadEntries;
...
public class MondayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facultyScheduleRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_fragment_monday);
        ...
        String[] selectionArgs = {String.valueOf(selectedFacultyId),String.valueOf(1)};
        ...
        while (cursor.moveToNext()) {
            ...
            String answer = cursor.getString(cursor.getColumnIndexOrThrow("teacher_id"));
