...
public class FridayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facultyScheduleRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_fragment_friday);
        ...
        String[] selectionArgs = {String.valueOf(selectedFacultyId),String.valueOf(5)};
